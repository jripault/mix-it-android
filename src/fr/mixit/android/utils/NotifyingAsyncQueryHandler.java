...
public class NotifyingAsyncQueryHandler extends AsyncQueryHandler {
     ...
     * {@link AsyncQueryListener#onQueryComplete(int, Object, android.database.Cursor)} is
    ...
    /**
     * Begin an asynchronous query with the given arguments. When finished,
     * {@link AsyncQueryListener#onQueryComplete(int, Object, android.database.Cursor)} is called
     * if a valid {@link AsyncQueryListener} is present.
     *
     * @param token Unique identifier passed through to
     *            {@link AsyncQueryListener#onQueryComplete(int, Object, android.database.Cursor)}
     */
